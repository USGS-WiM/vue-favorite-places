For archived repos, add the following to the top of the existing ReadMe, or create a new README.MD; Also add the code.json, set the "status" property to "Archival"
